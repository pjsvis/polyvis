...
export class Harvester {
     ...
     */
    public filterKnown(tags: Map<string, string[]>, knownIds: Set<string>): Map<string, string[]> {
     ...
     */
    public sortAndCluster(tags: Map<string, string[]>): { tag: string, count: number, files: string[] }[] {
