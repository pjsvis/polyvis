...
| :--- | :--- | :--- |
| **Open Props** | **The Source of Truth** | Provides the mathematical/design tokens (spacing, color, easing). **(The "What")** |
...
* **Beneficiary:** This creates a "Maximum Signal-to-Noise" environment, explicitly noted as being optimized for **Coding Agents** as well as humans.
