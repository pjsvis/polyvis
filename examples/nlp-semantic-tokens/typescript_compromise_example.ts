...
const customDoc = nlp("Tesla Model 3 and Rivian R1T are electric vehicles. Bitcoin reached $50000.");
...
console.log("Person + Verb pattern:", patternDoc.match('#Person #Verb').out('array'));
