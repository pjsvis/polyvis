...
const PATTERNS = [
  // Backgrounds
  {
    regex: /bg-(gray|white|black|slate|zinc|neutral|stone|red|blue|green)-[0-9]+/g,
    message: "Avoid hardcoded background colors. Use semantic variables like bg-[var(--surface-1)].",
  },
  {
  ...
  // Text
  {
    regex: /text-(gray|white|black|slate|zinc|neutral|stone|red|blue|green)-[0-9]+/g,
    message: "Avoid hardcoded text colors. Use semantic variables like text-[var(--text-1)].",
  },
  {
