...
console.log(`Delta: +${s1.rss - baseline.rss}MB RSS, +${s1.heap - baseline.heap}MB Heap`);
...
*/
console.log("SKIPPED. To profile: `bun add graphology` and uncomment code in scripts/profile_memory.ts");
...
console.log(`Delta (cumulative): +${s3.rss - baseline.rss}MB RSS, +${s3.heap - baseline.heap}MB Heap`);
console.log(`Step Cost: ~${s3.rss - s2.rss}MB RSS (Likely WASM/Model overhead)`);
