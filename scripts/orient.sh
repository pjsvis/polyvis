...
echo ""
echo "▸ agent files"
echo "  SYSTEM.md           — Edinburgh Protocol (system prompt for non-pi agents)"
echo "  AGENTS.md           — polyvis operational charter (protocols + tiers)"
echo "  HUMANS.md           — how to drive the agent"
echo ""
